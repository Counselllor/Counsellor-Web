...
export default function Login() {
  ...
  const generateCaptcha = () => {
    ...
    const hashedCaptcha = createHash("sha256").update(captcha).digest("hex");
    setCaptchaVal("");
    setCaptchaHash(hashedCaptcha);
  }
        ...
        <div className="parent">
          <div className="right">
            ...
            <form className="form" onSubmit={handleSignIn}>
              ...
              <div id="captcha-container">
                ...
                <div className="flex flex-row gap-3 justify-center items-center" id="captchaBox">
                  <div id="captcha">{captchaHash}</div>
                  <FaSyncAlt id="captchaIcon" onClick={generateCaptcha}/>
                  <div className="iconContainer">
                    <input
                      type="text"
                      name="captcha" // Corrected typo
                      value={captchaVal}
            ...
            <div className="dont-have-account">
              <Link to="/signup" className="forgot-password">Don't have an account?</Link>
            </div>
