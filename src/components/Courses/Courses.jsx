          ...
          <div className="container">
            <div className="about-content">
              <h2 className="section-title">
                The Best Courses for Your <span className="span">Academic</span>{" "}
                Journey
              </h2>
              <p className="section-text">
                With over a decade of expertise, we&aposre dedicated to
                empowering individuals worldwide through accessible and
                innovative online learning. Join us on a journey of growth and
                opportunity today!
              </p>
