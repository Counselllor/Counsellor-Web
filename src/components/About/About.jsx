    ...
    <main>
        <section class="section-about">
            ...
            <div class="row">
                <div class="col-1-of-2">
                    <h3 class="heading-tertiary u-margin-bottom-small">Our mission? To bestow upon students the gift of wisdom, aiding them in their quest for undergraduate enlightenment. Prepare to witness the extraordinary!</h3>
                    <p class="paragraph">
                ...
                <div class="col-1-of-2">
                    <div class="composition">
                        <img src="https://t4.ftcdn.net/jpg/05/39/10/47/360_F_539104776_BchIZKRhIUXDY0ZaVHxaoIDvRa2eAG3d.jpg" alt="photo 1" class="composition__photo composition__photo--p1"/>
                        <img src="https://www.thestatesman.com/wp-content/uploads/2020/09/QT-Indian-students.jpg" alt="photo 2" class="composition__photo composition__photo--p2"/>
                        <img src="https://t3.ftcdn.net/jpg/03/88/97/92/360_F_388979227_lKgqMJPO5ExItAuN4tuwyPeiknwrR7t2.jpg" alt="photo 3" class="composition__photo composition__photo--p3"/>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-1-of-4">
                    <div class="feature-box">
                        ...
                        <h3 class="heading-tertiary u-margin-bottom-small">Right Stream</h3>
                        <p class="feature-box__text">
                ...
                <div class="col-1-of-4">
                    <div class="feature-box">
                        ...
                        <h3 class="heading-tertiary u-margin-bottom-small">Right College</h3>
                        <p class="feature-box__text">
                ...
                <div class="col-1-of-4">
                    <div class="feature-box">
                        ...
                        <h3 class="heading-tertiary u-margin-bottom-small">Live Your Life</h3>
                        <p class="feature-box__text">
                    ...
                    <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <h4 class="card__heading">
                                <span class="card__heading-span card__heading-span--1">Indian Colleges</span>
                            </h4>
                ...
                <div class="col-1-of-3">
                    <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <h4 class="card__heading">
                                <span class="card__heading-span card__heading-span--2">American Colleges</span>
                            </h4>
                            <div class="card__details">
                                <ul>
                                    <li>300+</li>
                ...
                <div class="col-1-of-3">
                    <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <h4 class="card__heading">
                                <span class="card__heading-span card__heading-span--3">Austrian Colleges</span>
                            </h4>
                            <div class="card__details">
                                <ul>
                                    <li>100+</li>
        ...
        <section class="section-stories">
            ...
            <div class="row">
                <div class="story">
                    <figure class="story__shape">
                        <img src="https://bsa.web.unc.edu/wp-content/uploads/sites/14595/2019/10/kushal_student_profile.jpg" alt="Person on a Tour" class="story__img"/>
                        <figcaption class="story__caption">Mary Smith</figcaption>
                    </figure>

                    <div class="story__text">
                        <h3 class="heading-tertiary u-margin-bottom-small">I got the best college with their guidance</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae voluptatibus accusantium esse
                            quibusdam repellat molestiae a modi non, incidunt nisi minus labore quas blanditiis mollitia
                            autem sapiente sint laboriosam fugiat?</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="story">
                    <figure class="story__shape">
                        <img src="https://img.freepik.com/free-photo/young-man-student-with-notebooks-showing-thumb-up-approval-smiling-satisfied-blue-studio-background_1258-65334.jpg" alt="Person on a Tour" class="story__img"/>
